...
/////////////////////////
int PreOrderTraversal1(struct node* T)
{
    if(T!=NULL)
    {
        printf("%d",T->data);
        PreOrderTraversal1(T->left);
        PreOrderTraversal1(T->right);
    }
}
int InOrderTraversal1(struct node* T)
{
    if(T!=NULL)
    {
...
int PreOrderTraversal2(struct node* T)
{
    if(T!=NULL)
    {
        printf("%d",T->data);
        PreOrderTraversal2(T->left);
        PreOrderTraversal2(T->right);
    }
}
int InOrderTraversal2(struct node* T)
{
    if(T!=NULL)
    {
...
if(PreOrderTraversal1(T)==PreOrderTraversal2(T) &&InOrderTraversal1(T)==InOrderTraversal2(T))
{
    printf("identical");
}
else
